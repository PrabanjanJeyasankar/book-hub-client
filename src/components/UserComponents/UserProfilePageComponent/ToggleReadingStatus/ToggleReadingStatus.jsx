    ...
    return ( 
        <div className='toggle-reading-status'> 
            <div className='toggle-switch'> 
                <div className={`slider ${selectedReadingStatus}`} /> 
                <span 
                    className={ 
                        selectedReadingStatus === 'finishedReading' 
                            ? 'active' 
                            : '' 
                    } 
                ...
                <span 
                    className={ 
                        selectedReadingStatus === 'currentlyReading' 
                            ? 'active' 
                            : '' 
                    } 
                    onClick={() => handleStatusChange('currentlyReading')}> 
                    Currently Reading 
                    <span className='blink_me_currently_reading'> 
                        {largeDot} 
                    </span> 
                </span> 
                ...
                <span 
                    className={ 
                        selectedReadingStatus === 'wantToRead' ? 'active' : '' 
                    } 
